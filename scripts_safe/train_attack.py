...
Prerequisites:
  - datasets_safe/aes128/train/*.npz and datasets_safe/aes128/test/*.npz created by
    scripts/build_dataset.py

Outputs:
  models_safe/aes128/byte_NN.keras   — best-val-acc checkpoint per key byte
...
TRAIN_GLOB       = f"datasets_safe/{ALGORITHM}/train/*"
TEST_GLOB        = f"datasets_safe/{ALGORITHM}/test/*"
...
def main():
    ...
    models_dir = Path(f"models_safe/{ALGORITHM}")
